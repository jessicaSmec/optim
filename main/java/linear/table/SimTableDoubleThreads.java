...
public class SimTableDoubleThreads {
    private Map<String,Integer> goal;
    private double[][] table;
    private  double[][] tableColumn;
    private  double[][] koef ;
    private  double[][] koefColumn;
    private  double f[];
    private  double b[];
    private  String [] base;
    private  String [] free;
    private  double mainElem;
    private  int mainRow;
    ...
    public SimTableDoubleThreads(double[][] table, String[] base, String[] free) throws InterruptedException {
        /*
        setBase(base);
        setFree(free);
        setTable(table);
 ...
 */
    ...
    void changeOthers (int i, int j){
        ...
        this.mainElem*(this.table[i][j]-this.arr[this.mainRow][j]*arr[i][this.mainColumn])/this.mainElem;
    ...
    void changeTable() throws InterruptedException {
         arr = new double[this.table.length][this.table[0].length];
        for(int i =0; i<this.table.length;i++){
            for(int j =0; j<this.table[0].length;j++){
                arr[i][j] = this.table[i][j];
            } }
 ...
 */
        this.table[this.mainRow][this.mainColumn] =this.table[this.mainRow][this.mainColumn]/this.mainElem;
